      ...
      <React.Fragment>
        <div className="p-col-12 p-lg-6">
          <div className={commonStyles.TextBox}>
            ...
            <p>안녕하십니까?</p>
            <p>
              우리 대학에서는 학생들이 보다 넓은 시각으로 세상을 바라보고 미래를 설계하는 데 도움을 주기 위해 2016학년도
              여름방학부터 POSTECH SES(Summer Experience in Society) 프로그램을 실시하고 있으며, 취업과 창업, 유학 관련
              정보 제공 및 기업체 설명회, 채용박람회 개최 등 학생들에게 본부 및 학과차원의 조직적인 취업 및 진로지원
              프로그램을 마련하여 진로설계에 기반이 되는 서비스를 제공하고자 노력하고 있습니다.
            </p>
            <p>
