        ...
        <div className="p-col-12 p-lg-6">
          <div className={commonStyles.TextBox}>
            ...
            <ul>
              ...
              <p>
                교육과학기술부와 한국직업능력개발원의 주도하에 한국교육평가학회와 다수의 전문가의 지원을 받아 개발된
                진단 도구로써, 의사소통역량, 글로벌역량, 대인관계역량, 종합적 사고력, 자원·정보·기술의 활용역량,
                자기관리역량 등 6개 영역에서 대학생들의 핵심능력 및 역량 정도를 진단하여 취업능력 제고를 위한 자기계발
                가이드를 제공합니다.
              </p>
            </ul>
