    ...
    <Main title={'SES 소개'}>
      <React.Fragment>
        ...
        <div className="p-col-12 p-lg-5">
          <div className={commonStyles.ImageBox}>
        ...
        <div className="p-col-12 p-lg-6">
          <div className={commonStyles.TextBox}>
            ...
            <p style={{ lineHeight: '26px' }}>
              POSTECH SES(Summer Experience in Society) 프로그램은 학생들이 보다 넓은 시각으로 세상을 바라보고 미래를
              설계하는 데 도움을 주기 위해 2016학년도 여름방학부터 실시하고 있는 새로운 차원의 대학교육입니다.
            </p>
            <p style={{ lineHeight: '26px' }}>
              학생들은 산업 및 연구 현장에서의인턴 활동을 통해 교실에서 배운 이론과 지식이 실무에 어떻게 적용되는지를
        ...
        <div className={commonStyles.ImageContainer}>
          <img style={{ width: '100%' }} src={ses2Img} alt="ses2Img" />
        </div>
      </React.Fragment>
    </Main>
  );
