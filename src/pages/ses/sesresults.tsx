              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    LG화학(생명과학연구소), SK C&amp;C, SK이노베이션, SK하이닉스, 고려제강, 네이버, 다원시스,
                    두산중공업, 롯데첨단소재, 롯데케미칼, 뤼이드, 모르페우스, 삼성바이오에피스, 스마투스,스켈터랩스,
                    씨이랩, 에스에이피랩스코리아, 에스엘바이젠, 에스이티시스템, 엑셈, 엔시소프트, 온세미컨덕터 코리아,
                    원익홀딩스, 입센코리아, 정진국제특허법률사무소, 조이시티, 주성엔지니어링, 지멘스헬스케어, 카카오,
                    코레스, 퍼즐데이터, 하포리서치 코리아, 한화케미칼 중앙연구소, 한화큐셀
                  </td>
                  <td>40</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>포스코패밀리사</td>
                  <td>
                    포스코, 포스코 ict, 포스코건설, 포스코대우, 포스코에너지, 포스코엠텍, 포스코켐텍, 포스코플랜텍, RIST
                  </td>
                  <td>9</td>
                </tr>
                <tr>
                  <td>동문기업</td>
                  <td>
                    노매드커넥션, 데일리인텔리전스, 바이클립, 베이글코드, 스테이지랩스, 클리노믹스, 펜타시큐리티시스템,
                    펨토펩, 피엠그로우, 현대오토하우
                  </td>
                  <td>10</td>
                </tr>
